...
import DialogPromotionFloorProxy from "@/_skin001/views/dialog_promotion_floor/proxy/DialogPromotionFloorProxy";
import dialog_promotion_floor from "@/_skin001/views/dialog_promotion_floor";
import Vue from "vue";
...
export default class DialogDirectlyProxy extends puremvc.Proxy {
    ...
    api_user_var_agent_direct_list() {
        ...
        const parameter = {
            ...
            page_count: this.pageData.listQuery.page_count,
        };
        this.parameter.user_id = core.user_id;
        this.parameter.page_count = this.pageData.listQuery.page_count;
        this.sendNotification(net.HttpType.api_user_var_agent_direct_list, objectRemoveNull({ ...parameter }));
    }
