...
import DialogAgentManagerProxy from "@/_skin001/views/dialog_agent_manager/proxy/DialogAgentManagerProxy";
...
export default class DialogDirectlySettingMediator extends AbstractMediator {
    ...
    public handleNotification(notification: puremvc.INotification): void {
        ...
        const dialog_agent_manager: DialogAgentManagerProxy = getProxy(DialogAgentManagerProxy);
