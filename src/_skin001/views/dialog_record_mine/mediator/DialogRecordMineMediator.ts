...
import dialog_record_mine_detail from "@/_skin001/views/dialog_record_mine_detail";
import DialogRecordMineDetailProxy from "@/_skin001/views/dialog_record_mine_detail/proxy/DialogRecordMineDetailProxy";
