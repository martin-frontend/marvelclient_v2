...
import dialog_bet_record from "@/_skin003/views/dialog_bet_record";
import dialog_email from "@/_skin003/views/dialog_email";
...
import page_introduce from "@/_skin003/views/page_introduce";
import page_mine from "@/views/page_mine";
import page_bonus from "@/_skin003/views/page_bonus";
import { Prop, Watch, Component } from "vue-property-decorator";
import LangUtil from "@/core/global/LangUtil";
import GamePlatConfig from "@/core/config/GamePlatConfig";
import dialog_user_center from "@/_skin003/views/dialog_user_center";
