...
import dialog_pledge from "@/_skin003/views/dialog_pledge";
import dialog_manually_unstaking from "@/views/dialog_manually_unstaking";
import dialog_pledge_records from "@/_skin003/views/dialog_pledge_records";
import dialog_wallet from "@/_skin003/views/dialog_wallet";
import dialog_message_box from "@/views/dialog_message_box";
import GamePlatConfig from "@/core/config/GamePlatConfig";
import LangUtil from "@/core/global/LangUtil";
import FagProxy from "@/proxy/FagProxy";
import { getTodayGMT } from "@/core/global/Functions";
import dialog_bonus_ranking from "@/_skin003/views/dialog_bonus_ranking";
...
export default class PageBonus extends AbstractView {
    ...
    testData() {
        const obj = {
            username: "测试",
            stake_amount: "312312312432",
            bonus_amount: "4543565",
            total_bonus_amount: 65,
            bar: 0.2,
            date: "2022-11-18 16:54:14",
        };
        const arr = [];
    ...
    get bonus_recently() {
        //console.log("----this.myProxy.pageData.bonus_recently---" ,this.myProxy.pageData.bonus_recently)
        //return this.testData();
