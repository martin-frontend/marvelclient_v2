...
export default class DialogActivity7days extends AbstractView {
    ...
    onGetBtnClick() {
        LoginEnter(() => {
            ...
            // const recharge_proxy: RechargeProxy = this.getProxy(DialogRechargeProxy).rechargeProxy;
            // // const proxy = PanelUtil.getProxy_recharge;
            // recharge_proxy.api_user_var_recharge_method_list();
    ...
    onRuleBtnClick() {
        ...
        dialog_activity_detail.show(obj);
    }
    ...
    get dailyDataArray() {
        if (this.isCanGet) {
            ...
            console.warn("--->>>,,,112312", this.myProxy.pageData.rechargeActiveData);
