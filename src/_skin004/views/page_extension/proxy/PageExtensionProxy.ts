...
export default class PageExtensionProxy extends puremvc.Proxy {
    ...
    setData(data: any) {
        ...
        if (data.commission_info[2].commission_num[this.curCoinName] != undefined) {
            this.pageData.promotionData.commission_num = data.commission_info[2].commission_num[this.curCoinName];
        } else {
