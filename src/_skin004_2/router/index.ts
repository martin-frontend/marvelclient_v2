...
const routes: Array<RouteConfig> = [
    {
        path: "/",
        name: "page_home",
        component: () => import(/* webpackChunkName: "skin001_page_home" */ "@/_skin004_2/views/page_home/views/PageHome.vue"),
    },
    {
        path: "/page_game_list",
        name: "page_game_list",
    ...
    },
    {
        path: "/page_activity",
        name: "page_activity",
        component: () => import(/* webpackChunkName: "skin004_page_activity" */ "@/_skin004_2/views/page_activity/views/PageActivity.vue"),
    },
];
