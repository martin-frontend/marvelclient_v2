...
import UserPanel from "@/_skin004_6/views/header/widget/user_panel/UserPanel.vue";
import APP from "@/_skin004_5/App";
import GameSearch from "@/views/game_search/views/GameSearch.vue";
import HeaderMobile from "@/_skin004_6/views/header_mobile/views/HeaderMobile.vue";
