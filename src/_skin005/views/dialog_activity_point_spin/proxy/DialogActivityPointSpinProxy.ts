...
export default class DialogActivityPointSpinProxy extends puremvc.Proxy {
    ...
    getAwardImgPathByType(type: any, params: any) {
        ...
        if (isNoValue) {
            return require(`@/_skin005/assets/activity_point_spin/item_thanks_2.png`);
        }
        ...
        switch (type) {
            ...
            case 4:
                return require(`@/_skin005/assets/activity_point_spin/item_thanks.png`);
            case 90:
                return require(`@/_skin005/assets/activity_point_spin/item_coin.png`);
            case 91:
                return require(`@/_skin005/assets/activity_point_spin/item_ticks.png`);
