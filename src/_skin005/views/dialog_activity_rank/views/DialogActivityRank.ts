...
export default class DialogActivityRank extends AbstractView {
    ...
    get titleImg() {
        ...
        return require(`@/_skin005/assets/activity_rank_list/title/${lang}.png`);
    }
    get overtimeImg() {
        let lang = core.lang;
        ...
        return require(`@/_skin005/assets/activity_rank_list/overtime/${lang}.png`);
    }
    ...
    onGameItemClick(item: any) {
        ...
        if (item) {
            if (item.status == 1) {
                ...
                PanelUtil.message_alert(LangUtil("{0}正在维护", item.vendor_product_name));
            }
        }
    }
