...
export default class DialogLimitedBonus extends AbstractView {
    ...
    get titleImg() {
        ...
        return require(`@/_skin005/assets/limit_bonus/${lang}/title.png`);
    }
    get getBtnTextImg() {
        let lang = core.lang;
        ...
        return require(`@/_skin005/assets/limit_bonus/${lang}/get_text.png`);
    }

    getTimeImg(count: number) {
        return require(`@/_skin005/assets/limit_bonus/public/time_${count}.png`);
    }
}
