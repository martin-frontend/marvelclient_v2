...
import CustomInputLoginMobile from "@/_skin005/views/widget/custom_input_nomal_login_mobile/CustomInputNomal.vue";
import CustomPassword from "@/_skin005/views/widget/custom_password_nomal/CustomPasswordNomal.vue";
import CustomPasswordLoginMobile from "@/_skin005/views/widget/custom_password_nomal_login_mobile/CustomPasswordNomal.vue";
...
@Component({
    components: {
        ...
        CustomPassword,
        AdvertiseInLogin,
        CustomInputLoginMobile,
        CustomPasswordLoginMobile
    },
})
