...
/**为URL附加参数 */
function getSelectionName(market_type: string, selection: SelectionVO, matche?: MatcheVO, noBet: boolean = false): string {
    switch (market_type) {
        ...
        case EnumMarketType.TOTAL_GOALS_HALF_TIME:
            return (selection.type == "Overs" ? LangUtil("大") : LangUtil("小")) + " " + selection.handicap;
