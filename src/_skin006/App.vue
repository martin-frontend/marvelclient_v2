...
import App from "@/_skin005/App";
import Footer from "@/_skin005/views/footer/Footer.vue";
import Header from "@/_skin005/views/header/Header.vue";
import UserPanel from "@/_skin005/views/header/user_panel/UserPanel.vue";
import DialogMessage from "@/_skin005/views/dialog_message/views/DialogMessage.vue";
