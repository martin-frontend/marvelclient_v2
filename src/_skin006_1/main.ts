...
import { getRouter, routes } from "@/_skin006_1/router";
import "@/_skin006_1/style/main.css";
...
Assets.commonIcon.loading_img = "loading_icon_6_1.png?" + getVersion();
Assets.commonIcon.logo = require(`@/_skin006_1/assets/logo.png`);
Assets.commonIcon.logo_m = require(`@/_skin006_1/assets/logo_m.png`);
Assets.commonIcon.login_logo_m = require(`@/_skin006_1/assets/login_logo_m.png`);
