...
Assets.commonIcon.loading_img = "loding_icon_13.png?" + getVersion();
Assets.commonIcon.logo = require(`@/_skin013/assets/logo.png`);
Assets.commonIcon.logo_m = require(`@/_skin013/assets/logo_m.png`);
Assets.commonIcon.login_logo_m = require(`@/_skin013/assets/login_logo_m.png`);
