...
Assets.commonIcon.loading = require(`@/_skin017/assets/loading.gif`);
Assets.commonIcon.logo = require(`@/_skin017/assets/logo.png`);
Assets.commonIcon.logo_m = require(`@/_skin017/assets/logo_m.png`);
Assets.commonIcon.cat_icon = require(`@/_skin017/assets/mine/cat_icon.png`);
Assets.commonIcon.about_02_bg = require(`@/_skin017/assets/mine/about_02_icon_bg.png`);
Assets.commonIcon.about_03_bg = require(`@/_skin017/assets/mine/about_03_icon_bg.png`);
Assets.commonIcon.seventh_day_img = require(`@/_skin017/assets/daily_sign/gold_7.png`);
Assets.commonIcon.login_logo_m = require(`@/_skin017/assets/login_logo_m.png`);
...
SkinVariable.isUseGifLoading = true;
