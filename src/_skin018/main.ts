...
import Header from "@/_skin018/views/header/Header.vue";
import GameConfig from "@/core/config/GameConfig";
import { getVersion } from "@/core/global/Functions";
import { createSimpleTransition } from "vuetify/lib/components/transitions/createTransition";
import SlideVerify from "@/_skin005/views/widget/slide_verify/SlideVerify.vue";
Assets.commonIcon.loading_img = "loding_icon_16.png?" + getVersion();
Assets.commonIcon.logo = require(`@/_skin018/assets/logo.png`);
Assets.commonIcon.logo_m = require(`@/_skin018/assets/logo_m.png`);
Assets.commonIcon.login_logo_m = require(`@/_skin018/assets/login_logo_m.png`);
...
SkinVariable.activityDetailWidth = "60%";
...
setInterval(() => {
    ...
    if (window["vm"]) {
        ...
        Assets.commonIcon.logo = isDark ? require(`@/_skin018/assets/logo.png`) : require(`@/_skin018/assets/logo_light.png`);
