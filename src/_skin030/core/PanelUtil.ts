...
import AppProxy from "@/_skin030/AppProxy";
import LoginEnter from "@/_skin030/core/global/LoginEnter";

import NoticeProxy from "@/proxy/NoticeProxy";

/** 系统提示相关 */
import dialog_preview from "@/_skin030/views/dialog_preview";
import dialog_message_box from "@/_skin030/views/dialog_message_box";
import dialog_message from "@/_skin030/views/dialog_message";

import dialog_service from "@/_skin030/views/dialog_service";
import dialog_contract from "@/_skin030/views/dialog_contract";

/** 几个大的路由界面 以及 导航*/
import page_game_list from "@/_skin030/views/page_game_list";
import page_game_play from "@/_skin030/views/page_game_play";
...
/**登录 注册相关 */
import dialog_login from "@/_skin030/views/dialog_login";
import dialog_register from "@/_skin030/views/dialog_register";

import DialogLoginProxy from "@/_skin030/views/dialog_login/proxy/DialogLoginProxy";

/**邮件 公告 活动*/
import dialog_email from "@/_skin030/views/dialog_email";
import dialog_email_detail from "@/_skin030/views/dialog_email_detail";
import dialog_official_mail from "@/_skin030/views/dialog_official_mail";
//import dialog_activity from "@/_skin030/views/dialog_activity";
import dialog_activity_detail from "@/_skin030/views/dialog_activity_detail";
import dialog_activity_7days from "@/_skin030/views/dialog_activity_7days";
import dialog_notice_detail from "@/_skin030/views/dialog_notice_detail";
import dialog_notice from "@/_skin030/views/dialog_notice";

/**用户 信息 */
import dialog_user_center from "@/_skin030/views/dialog_user_center";
import dialog_plat_users_verification from "@/_skin030/views/dialog_plat_users_verification";
import dialog_real_name from "@/_skin030/views/dialog_real_name";
import dialog_nick_name from "@/_skin030/views/dialog_nick_name";
import dialog_safety_center from "@/_skin030/views/dialog_safety_center";
import dialog_google_settings from "@/_skin030/views/dialog_google_settings";
import dialog_bind_google from "@/_skin030/views/dialog_bind_google";
import dialog_google_verification from "@/_skin030/views/dialog_google_verification";
import dialog_personal_card from "@/_skin030/views/dialog_personal_card";

/**充值 提现 */
import dialog_recharge from "@/_skin030/views/dialog_recharge";
import dialog_wallet from "@/_skin030/views/dialog_wallet";
import dialog_game_rate from "@/_skin030/views/dialog_game_rate";
//import dialog_trade_password from "@/_skin030/views/dialog_trade_password";
import dialog_record_exchange from "@/_skin030/views/dialog_record_exchange";
import dialog_record_recharge from "@/_skin030/views/dialog_record_recharge";
import dialog_address_book from "@/_skin030/views/dialog_address_book";
import dialog_address_book_remark from "@/_skin030/views/dialog_address_book_remark";
import page_recharge from "@/_skin030/views/page_recharge";
import dialog_recharge_qrcode from "@/_skin030/views/dialog_recharge_qrcode";

import dialog_gold_water from "@/_skin030/views/dialog_gold_water";
import DialogRechargeProxy from "@/_skin030/views/dialog_recharge/proxy/DialogRechargeProxy";
import DialogAddressBookProxy from "@/_skin030/views/dialog_address_book/proxy/DialogAddressBookProxy";
import DialogAddressBookRemarkProxy from "@/_skin030/views/dialog_address_book_remark/proxy/DialogAddressBookRemarkProxy";

import PageRechargeProxy from "@/_skin030/views/page_recharge/proxy/PageRechargeProxy";
/**代理 */
import dialog_directly from "@/_skin030/views/dialog_directly";
import dialog_bind_invite from "@/_skin030/views/dialog_bind_invite";
import dialog_performance from "@/_skin030/views/dialog_performance";
import dialog_promotion_floor from "@/_skin030/views/dialog_promotion_floor";

import DialogDirectlyProxy from "@/_skin030/views/dialog_directly/proxy/DialogDirectlyProxy";
import DialogPromotionFloorProxy from "@/_skin030/views/dialog_promotion_floor/proxy/DialogPromotionFloorProxy";

/**投注记录 */
import dialog_bet_record from "@/_skin030/views/dialog_bet_record";
import dialog_bet_filter from "@/_skin030/views/dialog_bet_filter";
import dialog_order from "@/_skin030/views/dialog_order";

/**质押 */
import dialog_pledge from "@/_skin030/views/dialog_pledge";
import dialog_pledge_records from "@/_skin030/views/dialog_pledge_records";
import dialog_manually_unstaking from "@/_skin030/views/dialog_manually_unstaking";

/**挖矿 奖励 */
import dialog_award from "@/_skin030/views/dialog_award";
import dialog_record_mine from "@/_skin030/views/dialog_record_mine";
import dialog_record_mine_detail from "@/_skin030/views/dialog_record_mine_detail";
import DialogRecordMineDetailProxy from "@/_skin030/views/dialog_record_mine_detail/proxy/DialogRecordMineDetailProxy";

/** 信用 代理  信用统计 */
// import dialog_statistics_credit from "@/_skin030/views/dialog_statistics_credit";
// import dialog_agent_manager from "@/_skin030/views/dialog_agent_manager";
import dialog_directly_adduser from "@/_skin030/views/dialog_directly_adduser";
import dialog_directly_agentset from "@/_skin030/views/dialog_directly_agentset";
import dialog_directly_backwater from "@/_skin030/views/dialog_directly_backwater";
import dialog_directly_easybetset from "@/_skin030/views/dialog_directly_easybetset";
import dialog_directly_gameset from "@/_skin030/views/dialog_directly_gameset";
import dialog_directly_my from "@/_skin030/views/dialog_directly_my";
import dialog_directly_setting from "@/_skin030/views/dialog_directly_setting";
import dialog_directly_transfer from "@/_skin030/views/dialog_directly_transfer";
import dialog_directly_password from "@/_skin030/views/dialog_directly_password";
import dialog_edit_remark from "@/_skin030/views/dialog_edit_remark";
import dialog_promotion_statistics from "@/_skin030/views/dialog_promotion_statistics";

import DialogDirectlySettingProxy from "@/_skin030/views/dialog_directly_setting/proxy/DialogDirectlySettingProxy";
import DialogAgentManagerProxy from "@/_skin030/views/dialog_agent_manager/proxy/DialogAgentManagerProxy";
import DialogBetRecordProxy from "@/_skin030/views/dialog_bet_record/proxy/DialogBetRecordProxy";
import DialogStatisticsCreditProxy from "@/_skin030/views/dialog_statistics_credit/proxy/DialogStatisticsCreditProxy";
import DialogDirectlyMyProxy from "@/_skin030/views/dialog_directly_my/proxy/DialogDirectlyMyProxy";
import DialogPlatUsersVerificationProxy from "@/_skin030/views/dialog_plat_users_verification/proxy/DialogPlatUsersVerificationProxy";

import PageStatisticeCreditProxy from "@/_skin030/views/page_statistice_credit/proxy/PageStatisticeCreditProxy";

/** 其他  */
import dialog_swap_record from "@/_skin030/views/dialog_swap_record";
import dialog_bonus_ranking from "@/_skin030/views/dialog_bonus_ranking";
import dialog_performance_detail from "@/_skin030/views/dialog_performance_detail";
import dialog_timezone from "@/_skin030/views/dialog_timezone";

import dialog_get_verity from "@/_skin030/views/dialog_get_verity";
import DialogGetVerityProxy from "@/_skin030/views/dialog_get_verity/proxy/DialogGetVerityProxy";

import DialogPerformanceDetailProxy from "@/_skin030/views/dialog_performance_detail/proxy/DialogPerformanceDetailProxy";
...
import DialogPromotionRewardProxy from "@/_skin030/views/dialog_promotion_reward/proxy/DialogPromotionRewardProxy";
import GlobalVar from "@/core/global/GlobalVar";
import PageActivityProxy from "@/_skin030/views/page_activity/proxy/PageActivityProxy";
import PageCoinTaskProxy from "@/_skin030/views/page_coin_task/proxy/PageCoinTaskProxy";
...
export default class PanelUtil {
    ...
    */
    ...
    /**打开游戏大厅 */
    static openpage_casino_lobby() {
        this._openpage_base("page_casino_lobby", false);
    }
    //打开游戏列表 界面
    ...
    */
    ...
    static openpanel_gamelist(category?: number, vendor_id?: number) {
        ...
        page_casino_list.show(category, vendor_id);
    }

    //打开游戏列表窗口
    static openpanel_gamelist_sport(category?: number, vendor_id?: number) {
        //MultDialogManager.onOpenPanel(dialog_recharge);
        // page_game_list.show(category, vendor_id);
        page_casino_sport.show(category, vendor_id);
        // page_casino_list.show(category, vendor_id);
    }
    ...
    //活动的数据
    public static get getProxy_get_pageCasinoLobbyProxy(): PageCasinoLobbyProxy {
        return getProxy(PageCasinoLobbyProxy);
    }
    ...
    public static get funcMap(): any[] {
        if (!this._mapList || this._mapList.length < 1) {
            this._mapList = [
                ...
                {
                    key: "opencasino_history",
                    fun: () => {
                        PanelUtil.openpanel_gamelist(3);
                    },
                },
                {
