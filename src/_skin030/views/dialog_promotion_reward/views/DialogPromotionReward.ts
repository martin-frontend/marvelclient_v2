...
export default class DialogPromotionReward extends AbstractView {
    ...
    boxImgPath(index: any) {
        if (index < 3) {
            return require("@/_skin030/assets/promotion_reward/box1.png");
        } else if (index < 6 && index >= 3) {
            return require("@/_skin030/assets/promotion_reward/box2.png");
        } else {
            return require("@/_skin030/assets/promotion_reward/box3.png");
        }
    }
    ...
    get titleImg() {
        ...
        return require(`@/_skin030/assets/promotion_reward/title/${lang}.png`);
    }
}
