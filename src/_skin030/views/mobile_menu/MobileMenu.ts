...
import ServiceUtil from "@/_skin030/core/global/ServiceUtil";
...
export default class MobileMenu extends AbstractView {
    ...
    get menuList() {
        ...
        const list = <any>{
            ...
            2: { id: 2, mob_type: "casino", name: LangUtil("娱乐城"), icon: "casino", path: "/page_game_list" },
            ...
            11: { id: 11, mob_type: "mybet", name: LangUtil("我的投注"), icon: "mybet", path: "" },
            12: { id: 12, mob_type: "cs", name: LangUtil("客服"), icon: "cs", path: "" },
        };
