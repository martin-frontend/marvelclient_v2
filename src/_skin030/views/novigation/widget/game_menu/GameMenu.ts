...
export default class GameMenu extends AbstractView {
    ...
    onClick(item: any) {
        PanelUtil.getProxy_novigation.closeMenu();
        if (!item) return;
    ...
    get getImgPath(): any {
        try {
            return require(`@/_skin030/assets/novigation/menu_icon_${this.data.vendor_type}.png`);
        } catch (error) {
        ...
        //return require(`@/_skin030/assets/novigation/menu_icon_16.png`);
        // return require(`@/_skin030/assets/novigation/menu_icon_${this.data.vendor_type}.png`);
    }
