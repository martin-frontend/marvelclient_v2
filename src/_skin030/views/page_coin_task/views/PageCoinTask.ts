...
export default class PageCoinTask extends AbstractView {
    ...
    mappingImg(task_coin_name_unique: any) {
        ...
        const map = <any>{
            Slots: require("@/_skin030/assets/coin_task/slots.png"),
            Live: require("@/_skin030/assets/coin_task/live.png"),
            Casino: require("@/_skin030/assets/coin_task/live.png"),
            Cricket: require("@/_skin030/assets/coin_task/cricket.png"),
            FootBall: require("@/_skin030/assets/coin_task/footBall.png"),
            Sport: require("@/_skin030/assets/coin_task/sport.png"),
            All: require("@/_skin030/assets/coin_task/all.png"),
            Bonus: require("@/_skin030/assets/coin_task/bonus.png"),
        };
        return map[type];
    }
