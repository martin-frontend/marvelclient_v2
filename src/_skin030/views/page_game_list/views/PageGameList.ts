...
export default class PageGameList extends AbstractView {
    ...
    getLocalIconPath(vendor_type: any) {
        return require(`@/_skin030/assets/categoryicon/${vendor_type}.png`);
    }
    ...
    goCategory(id: any) {
        ...
        //PanelUtil.getProxy_navigation.categoryActive = id;
    ...
    destroyed() {
        PanelUtil.getProxy_navigation.categoryActive = 0;
        this.myProxy.clearData();
