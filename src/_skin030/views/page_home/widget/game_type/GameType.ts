    ...
    data = [
        {
            ...
            status: 1,
            path: "/cricket",
            icon: require(`@/_skin030/assets/gametype/Icons_Cricket.png`),
        },
        {
            ...
            category: 32,
            icon: require(`@/_skin030/assets/gametype/Icons_Casino.png`),
        },
        {
            ...
            path: "/slots-games",
            category: 16,
            icon: require(`@/_skin030/assets/gametype/Icons_Slots.png`),
        },
        {
            vendor_product_name: LangUtil("足球"),
            status: 1,
            path: "/page_game_soccer",
            icon: require(`@/_skin030/assets/gametype/Icons_Football.png`),
        },
    ];
