...
export default class GoldInfoUtil extends AbstractView {
    ...
    @Prop({ default: "" }) balanceStrColor!: string;
    ...
    trans_coin_img(coinname: string) {
        ...
        //return require(`@/_skin030/assets/coin/volare.png`);
        return require(`@/_skin030/assets/coin/${this.trans_coin_img_obj[coinname]}.png`);
    }
