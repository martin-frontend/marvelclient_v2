...
export default class DialogBetRecordProxy extends puremvc.Proxy {
    ...
    pageData = {
        ...
        listQuery: {
            ...
            start_date: core.dateFormat(core.getTodayOffset(), "yyyy-MM-dd") + ` 00:00:00`,
            end_date: core.dateFormat(core.getTodayOffset(1, 1), "yyyy-MM-dd") + ` 23:59:59`,
            page_count: 1,
            page_size: 20,
        },
        list: <any>[],
    ...
    listOptions = {
        ...
        statusColorOptions: () => {
            return {
                1: "yellow--text text--lighten-2",
                11: "teal--text text--accent-2",
