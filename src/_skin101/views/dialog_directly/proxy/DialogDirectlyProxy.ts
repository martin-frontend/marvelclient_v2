...
import DialogPromotionFloorProxy from "@/_skin101/views/dialog_promotion_floor/proxy/DialogPromotionFloorProxy";
import dialog_promotion_floor from "@/_skin101/views/dialog_promotion_floor";
import Vue from "vue";
