...
import dialog_register from "@/_skin101/views/dialog_register";
...
export default class Header extends AbstractView {
    ...
    CategoryIcon101 = Assets.CategoryIcon101;
    CategoryIconActive101 = Assets.CategoryIconActive101;
    ...
    scrollHandle() {
        ...
        //设置背景颜色的透明读
        if (scrollTop) {
            this.headerClass = "app-bar-middle";
        } else if (scrollTop == 0) {
            this.headerClass = "app-bar-toped";
        }
    }
