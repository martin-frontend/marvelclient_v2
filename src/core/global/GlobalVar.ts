...
export default class GlobalVar {
    ...
    public get isShowRegiter(): boolean {
        ...
        //     console.log("----dasdasd");
        // }
        if (GameConfig.config.modules_switch && GameConfig.config.modules_switch.register != undefined && GameConfig.config.modules_switch.register == 0)
            return false;
        else
            return true;
    }
    ...
    public get isShowRecharge(): boolean {
        if (GameConfig.config.modules_switch && GameConfig.config.modules_switch.recharge != undefined && GameConfig.config.modules_switch.recharge == 0)
            return false;
        else
            return true;
    }
    ...
    public get isShowExchange(): boolean {
        ...
        if (GameConfig.config.modules_switch && GameConfig.config.modules_switch.exchange != undefined && GameConfig.config.modules_switch.exchange == 0)
            return false;
        else
            return true;
    }
    ...
    public get isShowTransfer(): boolean {
        if (GameConfig.config.modules_switch && GameConfig.config.modules_switch.transfer != undefined && GameConfig.config.modules_switch.transfer == 0)
            return false;
        else
            return true;
